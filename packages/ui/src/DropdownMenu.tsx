...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[10rem] overflow-hidden rounded-lg border border-border bg-overlay p-1 text-foreground shadow-lg',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'transition-colors focus:bg-elevated focus:text-foreground',
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      'px-2 py-1.5 text-2xs font-medium uppercase tracking-wider text-foreground-tertiary',
      inset && 'pl-8',
      className,
    )}
    {...props}
...
// Re-exports for sub/check/radio if needed
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-overlay p-1 shadow-lg',
      className,
    )}
    {...props}
  />
