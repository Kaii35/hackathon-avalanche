...
/**
 * Text with an animated multi-stop gradient that "waves" across the glyphs
 * by shifting a CSS custom property (`--gi`) via requestAnimationFrame.
 *
 * Adapted for this repo (cn from @hack/ui instead of @/lib/utils). The CSS
 * variable `--gradient-wave-base` controls the rest-color for non-band
 * areas (defaults to near-black in light mode, near-white in dark mode).
 */
