...
/**
 * Dot-matrix shader background. Adapted from a public sign-in-flow snippet.
 *
 * Two modes:
 *   - reverse=false → dots fade IN from center outward (intro)
 *   - reverse=true  → dots fade OUT from edges inward (outro / loading)
 *
 * Used as the fullscreen backdrop for /login and /register.
 */
